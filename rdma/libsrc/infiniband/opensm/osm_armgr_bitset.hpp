...
public:
    ...
    */
    ...
    {
        /*
	 * this->b0 cotains mask for ports 0-63
	 * ar_subgroup->mask[31] contains mask for ports 0-7
	 */
        m_bitset[3] = cl_ntoh64(*((ib_net64_t*)&ar_subgroup.mask[0]));
        m_bitset[2] = cl_ntoh64(*((ib_net64_t*)&ar_subgroup.mask[8]));
        m_bitset[1] = cl_ntoh64(*((ib_net64_t*)&ar_subgroup.mask[16]));
        m_bitset[0] = cl_ntoh64(*((ib_net64_t*)&ar_subgroup.mask[24]));
	return *this;
    }
    ...
    */
	 ...
	 * ar_subgroup->mask[31] contains mask for ports 0-7
	 */
        *((ib_net64_t*)&ar_subgroup.mask[0]) = cl_hton64(m_bitset[3]);
        *((ib_net64_t*)&ar_subgroup.mask[8]) = cl_hton64(m_bitset[2]);
        *((ib_net64_t*)&ar_subgroup.mask[16]) = cl_hton64(m_bitset[1]);
        *((ib_net64_t*)&ar_subgroup.mask[24]) = cl_hton64(m_bitset[0]);
    }
